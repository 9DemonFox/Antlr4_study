...
public partial class MyGrammarBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IMyGrammarVisitor<Result> {
	...
	public virtual Result VisitParenthesis([NotNull] MyGrammarParser.ParenthesisContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitAddSubtraction([NotNull] MyGrammarParser.AddSubtractionContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMultiplyDivide([NotNull] MyGrammarParser.MultiplyDivideContext context) { return VisitChildren(context); }
