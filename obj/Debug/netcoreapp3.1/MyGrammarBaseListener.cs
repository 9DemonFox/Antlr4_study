...
public partial class MyGrammarBaseListener : IMyGrammarListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterAddSubtraction([NotNull] MyGrammarParser.AddSubtractionContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAddSubtraction([NotNull] MyGrammarParser.AddSubtractionContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMultiplyDivide([NotNull] MyGrammarParser.MultiplyDivideContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMultiplyDivide([NotNull] MyGrammarParser.MultiplyDivideContext context) { }
